        ...
        <div className="about-title">
          <div className="about-title-item">
            <div className="about-title-img">
              <img src={img1} alt="이미지1" id="img1"/>
            </div>
            <div className="about-title-label">
              <label htmlFor="img1">Cursor up</label>
            </div>
          </div>
          ...
          <div className="about-title-item">
            <div className="about-title-img">
              <img src={img2} alt="이미지2" id="img2"/>
            </div>
            <div className="about-title-label">
              <label htmlFor="img2">Value add</label>
            </div>
          </div>
          ...
          <div className="about-title-item">
            <div className="about-title-img">
              <img src={img3} alt="이미지3" id="img3"/>
            </div>
            <div className="about-title-label">
              <label htmlFor="img3">CUUVA</label>
            </div>
          </div>
        </div>
